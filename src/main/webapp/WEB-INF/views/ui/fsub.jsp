<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="css/fsub.css" rel="stylesheet">
		</head>
		...
		<body oncontextmenu="return blockRightClick()" class="body">
			...
			<div class="main" style="s">
				<div class="top">
					<div class="logo">
						<div><a href="map"><img class="logoimg" alt="copin" src="http://10.10.0.20:9999/img/copin.png"></a></div>
					</div>
				...
				<div class="mid">
					...
					<div class="midSide">
						<ul class="midSideNav">
							<li style="display: flex;" class="pointer"><i class="fab fa-google-drive"
									style="margin-top: 3px; margin-right: 11px;"></i> <a href="map"
									style="color: blue;">에셋 관리</a></li>
					...
					<div class="midBody">
						...
						<div class="midBodyMain">
							...
							<c:choose>
								<c:when test="${not empty subname }">
									<div style=" width: 100%;  ">
										<div class="flex-container">
											<c:forEach var="subname" items="${subname }">

												<div class="fname pointer" id="${subname.categoryname }">

													<c:if test="${not empty subname.productname}">
															<img  style="width: 250px; height: 150px; object-fit: contain;" 
															alt="${subname.categoryname }" src="http://10.10.0.20:9999/img/${subname.productname}">
													</c:if>
													
													<c:if test="${empty subname.productname}">
														<img style="width: 250px; height: 150px; object-fit: contain;"
															alt="${subname.categoryname }"
															src="http://10.10.0.20:9999/img/default.png">
													</c:if>
													<div style="height: 40px; text-align: center; line-height: 45px;">${subname.categoryname }</div>
							...
							<ul class="contextmenu">
								...
								<li class="move" style="display: flex;"><i class="fas fa-arrows-alt-h"
										style="margin-top: 7px; margin-right: 10px;"></i><a href="#">이동</a></li>
								...
								<div class="movecommand">
									<div style=" height: 50px; display: flex; ">
										...
										<div style=" padding-top: 10px; margin-left: auto; margin-right: 30px"
											class="moveClose pointer"><i class="fas fa-times"></i></div>
									</div>

									<div style=" height: 50px; margin-top: 10px; ">
										<input type="text" class="catname" name="catname" value="${catname }"
											style="display: none;">
										<input type="text" class="subname" name="subname" style="display: none;">
										<input type="text" class="mcatname" name="mcatname" style="display: none;">
										<select onchange="fn_handleOnChange(this)"
											style="width: 330px; height: 30px; margin-left: 30px; padding-left: 10px;">
											<c:forEach items="${catnamelist }" var="catname">
												<option class="default" value="${catname }">${catname }</option>
											</c:forEach>
										</select>
									</div>
									...
									<div
										...
										<input type="button" class="exit pointer moveClose" value="취소"
											onclick="fn_modifyclose()"
											style="background: white; width: 80px; height: 45px; border: none ">
										<input type="button" class="pointer" value="확인" onclick="fn_submove(this.form)"
							...
							<form>
								<div class="modifycommand" style=" ">
									...
									<div style=" height: 50px; margin-top: 10px; ">
										<input type="text" class="catnamemodify inputname" name="newname"
											style="width: 330px; height: 30px; margin-left: 30px; padding-left: 10px;"
											autocomplete="off">
										<input type="text" name="subname" style="display: none;">
									</div>
							...
							<form>
								<div class="insertCommand">
									...
									<div style=" height: 50px; margin-top: 10px; ">
										<input type="text" name="insertcatname" style="display: none"
											value="${catname }">
										<input type="text" class="inputpadding insertsubname" name="insertsubname"
